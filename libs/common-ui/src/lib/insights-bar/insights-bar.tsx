import styles from './insights-bar.module.scss';
    ...
    <Flex bg='white' w='100%' color='gray' justify='flex-start' align='center'>
      ...
      <div style={{marginLeft:'auto'}}>
        <Box>
          <Flex p={4}>
            <Box ml='3'>
              <Text fontWeight='bold' align={'right'}>LTV: 79.89</Text>
            </Box>
            <Box ml='3'>
              <Text fontWeight='bold' align={'right'}>GDS: 42.34</Text>
              <Text fontWeight='bold' align={'right'}>QGDS: 45.78</Text>
            </Box>
            <Box ml='3'>
              <Text fontWeight='bold' align={'right'}>TDS: 42.34</Text>
              <Text fontWeight='bold' align={'right'}>QTDS: 45.78</Text>
            </Box>
          </Flex>
        </Box>
      </div>
